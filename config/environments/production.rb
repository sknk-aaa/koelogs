...
Rails.application.configure do
  ...
  # Serve files from /public (including training audio assets on Render).
  ...
  mailer_host = ENV.fetch("MAILER_HOST", "example.com")
  mailer_port = ENV["MAILER_PORT"].presence&.to_i
  config.action_mailer.default_url_options = { host: mailer_host }
  config.action_mailer.default_url_options[:port] = mailer_port if mailer_port
